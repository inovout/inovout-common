...
public class StringUtils {
	 ...
	 */
	public static final Pattern ENV_VAR_PATTERN = Shell.WINDOWS ? WIN_ENV_VAR_PATTERN
	...
	public static String toRootPathString(String path) {
		if (!path.startsWith("/")) {
			path += "/";
		}
		return path;
	...
	public static String combinePathString(String parent, String relation) {
		if (!parent.endsWith("/")) {
			parent += "/";
		}
